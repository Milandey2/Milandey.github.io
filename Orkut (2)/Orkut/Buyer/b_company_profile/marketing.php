...
<form action="marketing_db.php" method="post">
       ...
       <img src="img/fb.jpg" alt="" width="2%"> <span style="color: #CE74A3; width: 160px;">facebook.com/</span> <input type="text" name="facebook" style="width: 250px padding: 2px; border: 3px solid #CE74A3;"><br><br>
       <img src="img/twit.png" alt="" width="2%"> <span style="color: #CE74A3; width: 160px;">twitter.com/</span> &nbsp;&nbsp;&nbsp; <input type="text" name="twitter" style="width: 250px padding: 2px; border: 3px solid #CE74A3;"><br><br>
       <img src="img/link.png" alt="" width="2%"> <span style="color: #CE74A3; width: 160px;">linkedin.com/</span> &nbsp;&nbsp;<input type="text" name="linkedin" style="width: 250px padding: 2px; border: 3px solid #CE74A3;"><br><br>
